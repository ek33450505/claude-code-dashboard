...
- `docs/archive/` contains stale/shipped planning artifacts (`LIVE_ACTIVITY_REDESIGN.md`, `superpowers/`) — not user-facing docs, kept for history only.
- **v3.0.0 (2026-09-03) — CAST v10 alignment shipped; dashboard is in maintenance mode.** No further feature work is queued. Any new work should be scoped fresh, not assumed to continue a prior plan.
