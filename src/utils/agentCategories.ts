export const AGENT_CATEGORIES = {
  Core: ['planner', 'debugger', 'test-writer', 'code-reviewer', 'data-scientist', 'db-reader', 'commit', 'security', 'push', 'bash-specialist'],
  Extended: ['architect', 'tdd-guide', 'build-error-resolver', 'e2e-runner', 'refactor-cleaner', 'doc-updater', 'readme-writer', 'router'],
  Specialist: ['devops', 'performance', 'seo-content', 'linter'],
...
export const CATEGORY_DESCRIPTIONS: Record<AgentCategory, string> = {
  ...
  Specialist: 'DevOps, performance, SEO, and linting specialists',
